...
module.exports = class AnimationManager extends EventEmitter {
	/**
	 * @param {Number} num_pixels The number of LEDs that are animated.
	 */
	...
	/**
	 * Creates an animation from the given model and starts it.
	 * @param {MAnimation} animation_model The model that describes the animation to display.
	 */
